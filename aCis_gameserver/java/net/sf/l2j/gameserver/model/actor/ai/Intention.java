...
public class Intention
{
	 ...
	 * @return true if all tested parameters are equal (intention and all parameters).
	 */
	public boolean equals(Intention intention)
	{
		return _intention == intention.getType() && _firstParameter == intention.getFirstParameter() && _secondParameter == intention.getSecondParameter();
	}
}